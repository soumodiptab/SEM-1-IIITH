...
void driver()
{
    ...
    switch(choice)
    {
        ...
        {  
            ...
            double **arr1=create_matrix<double>(row,col);
            initializer(a,arr1,row,col);
            cin>>row>>col;
            SparseMatrix<double>b(row,col);
            double **arr2=create_matrix<double>(row,col);
            initializer(b,arr2,row,col);
            SparseMatrix<double>c=a.add(b);
            c.print();
        }
            break;
        case 2://multiply
        {
            ...
            double **arr2=create_matrix<double>(row,col);
            initializer(b,arr2,row,col);
            SparseMatrix<double>c=a.multiply(b);
            c.print();
        }
            break;
        case 3 ://transpose
        {
            cin>>row>>col;
            SparseMatrix<double>a(row,col);
            double **arr=create_matrix<double>(row,col);
